 ...
 * @date 2020/8/26
 */
public class XyDsUserFormUpdateFactory extends AbstractJavaFileFactory<XyDsForm> {

    private IPoFactory poFactory;

    public XyDsUserFormUpdateFactory(IPoFactory poFactory) {
    ...
    protected String configYaml() {
        return "/themes/xy/dsuser/config/form-update.yaml";
    }
