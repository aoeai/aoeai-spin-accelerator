 ...
 * @date 2020/8/25
 */
public class XyRtcMapperTestFactory extends AbstractJavaFileFactory<MapperClass> implements IMapperFactory {

    private IPoFactory poFactory;

    public XyRtcMapperTestFactory(IPoFactory poFactory) {
    ...
    public MapperClass build(String tableName) {
        ...
        mapperClass.setTemplates("xy/rtc/mapper_test.ftl");
        return mapperClass;
    }

    @Override
    protected String configYaml() {
        return "/themes/xy/rtc/config/mapper-test.yaml";
    }
