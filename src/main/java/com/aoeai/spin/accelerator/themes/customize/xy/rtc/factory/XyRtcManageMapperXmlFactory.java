 ...
 * @date 2020/8/25
 */
public class XyRtcManageMapperXmlFactory implements IMapperXmlFactory {

    private IMapperFactory mapperFactory;

    public XyRtcManageMapperXmlFactory(IMapperFactory mapperFactory) {
    ...
    public MapperXml build(String tableName) {
        ...
        JavaConfig cfg = ConfigTools.getConfig("/themes/xy/rtc/config/manage-mapper-xml.yaml", JavaConfig.class);
        ...
        xml.setTemplates("xy/rtc/manage_mapper_xml.ftl");
