 ...
 */
@Component
public class QmKunyinUpdateRpcParamFactory implements IPoFactory {
    ...
    public Po build(String tableName) {
        Po po = new Po();
        PoConfig cfg = ConfigTools.getConfig("/themes/qm/kuyin/config/update_rpc_param.yaml", PoConfig.class);
