 ...
 * @date 2020/8/25
 */
public class XyMediaMapperXmlFactory implements IMapperXmlFactory {

    private IMapperFactory mapperFactory;

    public XyMediaMapperXmlFactory(IMapperFactory mapperFactory) {
    ...
    public MapperXml build(String tableName) {
        ...
        JavaConfig cfg = ConfigTools.getConfig("/themes/xy/media/config/mapper-xml.yaml", JavaConfig.class);
