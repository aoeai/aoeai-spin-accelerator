 ...
 * @date 2020/8/26
 */
public class XyDsServiceFactory extends AbstractJavaFileFactory<XyDsServiceClass> {

    private IPoFactory poFactory;

    private IMapperFactory mapperFactory;

    private XyDsVoFactory voFactory;

    private XyDsPageListQoFactory pageListQoFactory;

    public XyDsServiceFactory(IPoFactory poFactory, IMapperFactory mapperFactory,
                              XyDsVoFactory voFactory, XyDsPageListQoFactory pageListQoFactory) {
    ...
    protected String configYaml() {
        return "/themes/xy/dashang/config/service.yaml";
    }
