 ...
 * @date 2020/8/26
 */
public class XyDsUserControllerAppFactory extends AbstractJavaFileFactory<XyDsController> {
    ...
    public XyDsUserControllerAppFactory(IPoFactory poFactory, XyDsUserServiceFactory serviceFactory,
    ...
    protected String configYaml() {
        return "/themes/xy/dsuser/config/controller-app.yaml";
    }
