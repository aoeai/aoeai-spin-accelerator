...
@AllArgsConstructor
public class QmKuyinMapperFactory extends AbstractJavaFileFactory<MapperClass> implements IMapperFactory {
    ...
    public MapperClass build(String tableName) {
        ...
        mapperClass.setTemplates("qm/kuyin/mapper.ftl");
        return mapperClass;
    }

    @Override
    protected String configYaml() {
        return "/themes/qm/kuyin/config/mapper.yaml";
    }
