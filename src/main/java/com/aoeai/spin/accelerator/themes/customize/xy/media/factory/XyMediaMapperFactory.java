 ...
 * @date 2020/8/25
 */
public class XyMediaMapperFactory extends AbstractJavaFileFactory<MapperClass> implements IMapperFactory {

    private IPoFactory poFactory;

    public XyMediaMapperFactory(IPoFactory poFactory) {
    ...
    protected String configYaml() {
        return "/themes/xy/media/config/mapper.yaml";
    }
