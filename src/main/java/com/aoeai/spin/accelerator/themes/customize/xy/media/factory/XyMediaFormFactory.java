...
import com.aoeai.spin.accelerator.themes.customize.xy.media.bean.XyMediaForm;
 ...
 * @date 2020/8/26
 */
public class XyMediaFormFactory extends AbstractJavaFileFactory<XyMediaForm> {

    private IPoFactory poFactory;

    public XyMediaFormFactory(IPoFactory poFactory) {
     ...
     */
    @Override
    public XyMediaForm build(String tableName) {
        return create(tableName, new XyMediaForm());
    }
    ...
    protected String configYaml() {
        return "/themes/xy/media/config/form.yaml";
    }
    ...
    protected void manualCreate(String tableName) {
        ...
        List<XyMediaFormField> formFieldList = new ArrayList<>(po.getTable().getColumns().size());
        for (POField poField : po.getFieldList()) {
            XyMediaFormField formField = new XyMediaFormField();
