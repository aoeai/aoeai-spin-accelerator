 ...
 * @date 2020/8/25
 */
public class XyFinMapperFactory extends AbstractJavaFileFactory<MapperClass> implements IMapperFactory {

    private IPoFactory poFactory;

    public XyFinMapperFactory(IPoFactory poFactory) {
    ...
    protected String configYaml() {
        return "/themes/xy/finance/config/mapper.yaml";
    }
