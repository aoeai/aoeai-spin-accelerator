 ...
 * @date 2020/8/26
 */
public class XyDsUserPageListQoFactory extends AbstractJavaFileFactory<XyDsPageListQo> {

    private IPoFactory poFactory;

    public XyDsUserPageListQoFactory(IPoFactory poFactory) {
    ...
    protected String configYaml() {
        return "/themes/xy/dsuser/config/page-list-qo.yaml";
    }
