...
import com.aoeai.spin.accelerator.themes.customize.xy.finance.bean.XyFinFacadeTest;
 ...
 * @date 2020/8/26
 */
public class XyFinFacadeTestFactory extends AbstractJavaFileFactory<XyFinFacadeTest> {

    private IPoFactory poFactory;
    private XyFinFormFactory formFactory;
    private XyFinPageListQoFactory pageListQoFactory;

    public XyFinFacadeTestFactory(IPoFactory poFactory, XyFinFormFactory formFactory, XyFinPageListQoFactory pageListQoFactory) {
     ...
     */
    @Override
    public XyFinFacadeTest build(String tableName) {
        return create(tableName, new XyFinFacadeTest());
    }
    ...
    protected String configYaml() {
        return "/themes/xy/finance/config/facade-test.yaml";
    }
    ...
    protected void manualCreate(String tableName) {
        ...
        for (XyFinFormField field : builder.getForm().getFieldList()) {
            // 不填充主键
