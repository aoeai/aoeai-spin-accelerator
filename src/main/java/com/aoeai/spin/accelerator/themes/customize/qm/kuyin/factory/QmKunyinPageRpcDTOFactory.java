 ...
 */
@Component
public class QmKunyinPageRpcDTOFactory implements IPoFactory {
    ...
    public Po build(String tableName) {
        Po po = new Po();
        PoConfig cfg = ConfigTools.getConfig("/themes/qm/kuyin/config/page_rpc_dto.yaml", PoConfig.class);
