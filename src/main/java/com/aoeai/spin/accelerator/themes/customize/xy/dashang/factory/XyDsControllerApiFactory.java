 ...
 * @date 2020/8/26
 */
public class XyDsControllerApiFactory extends AbstractJavaFileFactory<XyDsController> {
    ...
    public XyDsControllerApiFactory(IPoFactory poFactory, XyDsServiceFactory serviceFactory,
    ...
    protected String configYaml() {
        return "/themes/xy/dashang/config/controller-api.yaml";
    }
